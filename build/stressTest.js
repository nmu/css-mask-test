// Modified from https://github.com/andyedinborough/stress-css/
...
var stressTest = (function () {
    ...
    function stressTest(state) {
        ...
        var sel,
            queue = state.queue = Object_keys(state.elms).filter(function(a, i){
              return !(a.match(/\.sprite\-/));
            }),
        ...
        console.log(queue);
        // NM: hack to skip the sprite- classes
        // queue = queue.filter(function(a, i){
        //   return !(a.match(/\.sprite\-/));
        // });
